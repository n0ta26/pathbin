...
pathbin v0.1.2 supports Rust 1.85 and newer.
...
v0.1.2 is an early, pre-1.0 release. Command behavior, human-readable output
...
pathbin v0.1.2 officially supports:

- Linux
- macOS

Windows support is experimental in v0.1.2. Other operating systems are
